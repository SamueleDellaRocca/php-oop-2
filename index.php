...
echo ("<h3>{$utenteUno->nomeCompleto} il tuo sconto sugli acquisti è del {$utenteUno->getSconto()}%</h3>");
var_dump($utenteCinque);
$utenteCinque->controlloScadenza($utenteCinque->scadenzaCartaCredito);
echo ("<h3>{$utenteCinque->nomeCompleto} il tuo sconto sugli acquisti è del {$utenteCinque->getSconto()}%</h3>");
